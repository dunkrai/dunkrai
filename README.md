...
Passionate about building scalable applications and leading development teams. Expertise in Java, Spring Boot, Android, Flutter, and modern web technologies.
...
- Oversee customization, end-to-end testing, unit testing, deployment, and project closure
- Conduct bugs analysis and lessons learned sessions
- Manage team members as a pool and delegate work across multiple teams
- Provide Level 3 Support for live products
...
- Built shipping integration for UPS, USPS, and FedEx with PHP APIs
- Developed software phone based on Java Felix OSGi integrated with Asterisk server
- Built plugins compatible with Call Care platform on XmlBlaster MOM Server
- Administered software and hardware for internal server units
...
- Developed Corporate Portal Platform for Dtac using BEA Portal WebLogic 9.2
- Customized with Java, Spring, Hibernate, XFire, and CFX WebService
...
- Built solutions with JBossCache, ANT, Log4j, Apache Tomcat, JBoss, JAAS, Struts, Hibernate
...
- Created LossOnline Project for tracking history loss time engine
...
- Developed intranet reports using JSP, EJB, XML, JBoss/Jetty 2.3
...
![Apache NiFi](https://img.shields.io/badge/NiFi-017CEE?style=for-the-badge&logo=apache&logoColor=white)

### Methodologies
![Agile](https://img.shields.io/badge/Agile-0052CC?style=for-the-badge&logo=agile&logoColor=white)
![SDLC](https://img.shields.io/badge/SDLC-4285F4?style=for-the-badge&logo=blueprint&logoColor=white)
![UML](https://img.shields.io/badge/UML-FABD14?style=for-the-badge&logo=uml&logoColor=black)
![OOP](https://img.shields.io/badge/OOP-007ACC?style=for-the-badge&logo=visualstudiocode&logoColor=white)
